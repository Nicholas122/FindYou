...
class OutgoingMessageListener implements EventSubscriberInterface
{
    private $em;
    ...
    {
        return array(
            array('event' => 'serializer.post_serialize', 'class' => 'AppBundle\Entity\OutgoingMessage', 'method' => 'onPostSerialize'),
        );
    }
